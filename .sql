--------------------------------------------------------
--  File created - Friday-April-04-2025   
--------------------------------------------------------
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Type ORDER_ITEM_RECORD
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."ORDER_ITEM_RECORD" AS OBJECT (
    product_id NUMBER,
    quantity NUMBER
);
...
/
--------------------------------------------------------
--  DDL for Type ORDER_ITEM_TABLE
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."ORDER_ITEM_TABLE" AS TABLE OF order_item_record;

/
--------------------------------------------------------
--  DDL for Type ORDER_ITEM_TYPE
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."ORDER_ITEM_TYPE" AS OBJECT (
    product_id NUMBER,
    quantity NUMBER
);
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CUSTOMERS" 
   (	"CUSTOMER_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DELIVERY" 
   (	"DELIVERY_ID" NUMBER, 
	"ORDER_ID" NUMBER, 
	"DELIVERY_DATE" DATE, 
	"DELIVERY_STATUS" VARCHAR2(50 BYTE) DEFAULT 'In Progress'
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DEPARTMENT" 
   (	"DPTID" VARCHAR2(10 BYTE), 
	"DPTNAME" VARCHAR2(30 BYTE), 
	"DPTLOCATION" VARCHAR2(30 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table DEPARTMENT1
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."DEPARTMENT1" 
   (	"DPTID" VARCHAR2(10 BYTE), 
	"DPTNAME" VARCHAR2(30 BYTE), 
	"DPTLOCATION" VARCHAR2(30 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."EMPLOYEE" 
   (	"EMPID" NUMBER, 
	...
	"EMPDOB" DATE, 
	"EMPCONTACT" VARCHAR2(11 BYTE), 
	"EMPCITY" VARCHAR2(50 BYTE), 
	"EMPDESIGNATION" VARCHAR2(50 BYTE), 
	"EMPJOINEDDATE" DATE, 
	"EMPBASICSALARY" NUMBER(10,2), 
	"EMPALLOWANCE" NUMBER(10,2), 
	"EMPDPTID" VARCHAR2(10 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SUPPLIER" 
   (	"SUPPLIER_ID" NUMBER(10,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"CONTACT_INFORMATION" VARCHAR2(255 CHAR), 
	"SUPPLIER_ADDRESS" VARCHAR2(255 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SUPPLIERS" 
   (	"SUPPLIER_ID" NUMBER, 
	...
	"CONTACT_INFORMATION" VARCHAR2(255 BYTE), 
	"SUPPLIER_ADDRESS" VARCHAR2(255 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMERS (CUSTOMER_ID,FULL_NAME,CUSTOMER_EMAIL,PHONE,CUSTOMER_ADDRESS,PASSWORD) values (1,'John Doe','john.doe@example.com','123-456-7890','123 Main St, Springfield, IL, 62701','password123');
Insert into SYSTEM.CUSTOMERS (CUSTOMER_ID,FULL_NAME,CUSTOMER_EMAIL,PHONE,CUSTOMER_ADDRESS,PASSWORD) values (2,'Jane Smith','jane.smith@example.com','987-654-3210','456 Elm St, Chicago, IL, 60601','securepassword');
Insert into SYSTEM.CUSTOMERS (CUSTOMER_ID,FULL_NAME,CUSTOMER_EMAIL,PHONE,CUSTOMER_ADDRESS,PASSWORD) values (3,'Robert Johnson','robert.johnson@example.com','555-123-4567','789 Oak St, Madison, WI, 53703','password456');
Insert into SYSTEM.CUSTOMERS (CUSTOMER_ID,FULL_NAME,CUSTOMER_EMAIL,PHONE,CUSTOMER_ADDRESS,PASSWORD) values (4,'Emily Davis','emily.davis@example.com','555-987-6543','321 Pine St, Seattle, WA, 98101','mypassword789');
Insert into SYSTEM.CUSTOMERS (CUSTOMER_ID,FULL_NAME,CUSTOMER_EMAIL,PHONE,CUSTOMER_ADDRESS,PASSWORD) values (5,'Michael Brown','michael.brown@example.com','444-123-7890','654 Maple St, Denver, CO, 80202','strongpassword');
Insert into SYSTEM.CUSTOMERS (CUSTOMER_ID,FULL_NAME,CUSTOMER_EMAIL,PHONE,CUSTOMER_ADDRESS,PASSWORD) values (6,'Linda Williams','linda.williams@example.com','333-654-9870','987 Birch St, Austin, TX, 73301','password321');
REM INSERTING into SYSTEM.DELIVERY
SET DEFINE OFF;
REM INSERTING into SYSTEM.DEPARTMENT
SET DEFINE OFF;
Insert into SYSTEM.DEPARTMENT (DPTID,DPTNAME,DPTLOCATION) values ('D001','Human Resource','Colombo');
Insert into SYSTEM.DEPARTMENT (DPTID,DPTNAME,DPTLOCATION) values ('D002','Account','Gampaha');
Insert into SYSTEM.DEPARTMENT (DPTID,DPTNAME,DPTLOCATION) values ('D003','Administration','Colombo');
REM INSERTING into SYSTEM.DEPARTMENT1
SET DEFINE OFF;
REM INSERTING into SYSTEM.EMPLOYEE
SET DEFINE OFF;
Insert into SYSTEM.EMPLOYEE (EMPID,EMPNAME,EMPDOB,EMPCONTACT,EMPCITY,EMPDESIGNATION,EMPJOINEDDATE,EMPBASICSALARY,EMPALLOWANCE,EMPDPTID) values (1001,'Amali Karunarathna',to_date('06/JAN/00','DD/MON/RR'),'0764554324','Kurunegala','HR Assistant',to_date('02/MAY/21','DD/MON/RR'),25000,8500,'D001');
Insert into SYSTEM.EMPLOYEE (EMPID,EMPNAME,EMPDOB,EMPCONTACT,EMPCITY,EMPDESIGNATION,EMPJOINEDDATE,EMPBASICSALARY,EMPALLOWANCE,EMPDPTID) values (1002,'Namal Bandara',to_date('28/APR/01','DD/MON/RR'),'0745676576','Colombo','Accountant',to_date('01/JAN/22','DD/MON/RR'),75000,10000,'D002');
Insert into SYSTEM.EMPLOYEE (EMPID,EMPNAME,EMPDOB,EMPCONTACT,EMPCITY,EMPDESIGNATION,EMPJOINEDDATE,EMPBASICSALARY,EMPALLOWANCE,EMPDPTID) values (1003,'Sandun Dissanayake',to_date('08/AUG/00','DD/MON/RR'),'0771233211','Gampaha','HR Assistant',to_date('01/JAN/22','DD/MON/RR'),25000,8500,'D001');
Insert into SYSTEM.EMPLOYEE (EMPID,EMPNAME,EMPDOB,EMPCONTACT,EMPCITY,EMPDESIGNATION,EMPJOINEDDATE,EMPBASICSALARY,EMPALLOWANCE,EMPDPTID) values (1004,'Danushka Bandara',to_date('04/OCT/02','DD/MON/RR'),'0764554324','Kurunegala','HR Assistant',to_date('10/MAY/21','DD/MON/RR'),25000,8500,'D001');
...
SET DEFINE OFF;
Insert into SYSTEM.ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_DATE,TOTAL_AMOUNT,STATUS) values (1,1,to_timestamp('02/APR/25 07:47:06.101000000 PM','DD/MON/RR HH12:MI:SSXFF AM'),150,'Pending');
Insert into SYSTEM.ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_DATE,TOTAL_AMOUNT,STATUS) values (2,1,to_timestamp('02/APR/25 07:51:46.011000000 PM','DD/MON/RR HH12:MI:SSXFF AM'),155.78,'Pending');
Insert into SYSTEM.ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_DATE,TOTAL_AMOUNT,STATUS) values (3,1,to_timestamp('02/APR/25 07:53:11.716000000 PM','DD/MON/RR HH12:MI:SSXFF AM'),165.97,'Pending');
Insert into SYSTEM.ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_DATE,TOTAL_AMOUNT,STATUS) values (4,1,to_timestamp('02/APR/25 07:56:24.257000000 PM','DD/MON/RR HH12:MI:SSXFF AM'),165.97,'Pending');
Insert into SYSTEM.ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_DATE,TOTAL_AMOUNT,STATUS) values (5,1,to_timestamp('02/APR/25 09:05:30.252000000 PM','DD/MON/RR HH12:MI:SSXFF AM'),35.75,'Pending');
Insert into SYSTEM.ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_DATE,TOTAL_AMOUNT,STATUS) values (8,1,to_timestamp('03/APR/25 06:26:32.154000000 PM','DD/MON/RR HH12:MI:SSXFF AM'),24.74,'Pending');
Insert into SYSTEM.ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_DATE,TOTAL_AMOUNT,STATUS) values (9,1,to_timestamp('03/APR/25 08:52:55.940000000 PM','DD/MON/RR HH12:MI:SSXFF AM'),54.71,'Pending');
REM INSERTING into SYSTEM.ORDER_ITEMS
SET DEFINE OFF;
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (1,2,1,2,5.78);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (2,3,7,2,5.98);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (3,3,9,1,9.99);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (4,4,7,2,5.98);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (5,4,9,1,9.99);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (6,5,1,2,5.78);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (7,5,9,3,29.97);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (9,8,1,2,5.78);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (10,8,7,3,8.97);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (11,8,9,1,9.99);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (12,9,1,2,5.78);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (13,9,7,3,8.97);
Insert into SYSTEM.ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,SUBTOTAL) values (14,9,9,4,39.96);
REM INSERTING into SYSTEM.PAYMENTS
SET DEFINE OFF;
REM INSERTING into SYSTEM.PRODUCTS
SET DEFINE OFF;
Insert into SYSTEM.PRODUCTS (PRODUCT_ID,SUPPLIER_ID,PRODUCT_NAME,PRODUCT_CATEGORY,PRICE,AVAILABLE_STOCK) values (9,2,'Blue Berries','Fruits',9.99,15);
Insert into SYSTEM.PRODUCTS (PRODUCT_ID,SUPPLIER_ID,PRODUCT_NAME,PRODUCT_CATEGORY,PRICE,AVAILABLE_STOCK) values (1,2,'Mangos','Fruits',2.89,6);
Insert into SYSTEM.PRODUCTS (PRODUCT_ID,SUPPLIER_ID,PRODUCT_NAME,PRODUCT_CATEGORY,PRICE,AVAILABLE_STOCK) values (7,1,'Organic Apples','Fruits',2.99,45);
Insert into SYSTEM.PRODUCTS (PRODUCT_ID,SUPPLIER_ID,PRODUCT_NAME,PRODUCT_CATEGORY,PRICE,AVAILABLE_STOCK) values (8,2,'Bananas','Fruits',1.2,99);
...
SET DEFINE OFF;
Insert into SYSTEM.SUPPLIERS (SUPPLIER_ID,SUPPLIER_NAME,CONTACT_INFORMATION,SUPPLIER_ADDRESS) values (1,'ABC Constructions','abc@email.com','123 Main Street, NY');
Insert into SYSTEM.SUPPLIERS (SUPPLIER_ID,SUPPLIER_NAME,CONTACT_INFORMATION,SUPPLIER_ADDRESS) values (2,'XYZ Hardware','xyz@email.com','456 Elm Street, LA');
Insert into SYSTEM.SUPPLIERS (SUPPLIER_ID,SUPPLIER_NAME,CONTACT_INFORMATION,SUPPLIER_ADDRESS) values (3,'BuildTech Supplies','buildtech@email.com','789 Oak Street, TX');
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Procedure ADD_EMP_SALARY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ADD_EMP_SALARY" (p_incentive Number)
IS
BEGIN
    UPDATE Employee1
    SET empbasicsalary = empbasicsalary + p_incentive
    where EmpBasicSalary > 50000;

    for recs1 in (select EmpID, EmpName, EmpBasicSalary, EmpAllowance, 
               (EmpBasicSalary + EmpAllowance) AS TotalSalary
        FROM Employee1 
        WHERE EmpBasicSalary > 50000)
    LOOP
    DBMS_OUTPUT.PUT_LINE('EmpID: ' || recs1.EmpID || 
                             ', Name: ' || recs1.EmpName || 
                             ', New Total Salary: ' || (recs1.EmpBasicSalary + recs1.EmpAllowance));
    END LOOP;
END;

EXEC Add_emp_salary(500);

/
--------------------------------------------------------
--  DDL for Procedure ADD_INCENTIVE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ADD_INCENTIVE" (incentive NUMBER) IS
     CURSOR emp_cursor IS
        SELECT EmpID, EmpName, EmpBasicSalary FROM EMPLOYEE WHERE EmpBasicSalary > 50000;
BEGIN
     FOR emp IN emp_cursor LOOP
         dbms_output.put_line('Employee ID: ' || emp.EmpID);
         dbms_output.put_line('Employee Name: ' || emp.EmpName);
         dbms_output.put_line('Employee BasicSalary: ' || (emp.EmpBasicSalary + incentive));
    END LOOP;
END add_incentive;

/
--------------------------------------------------------
--  DDL for Procedure ADD_ORDER_ITEM
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ADD_ORDER_ITEM" (
    p_order_id NUMBER,
    p_product_id NUMBER,
    p_quantity NUMBER
) AS
...
BEGIN
    ...
    SELECT price, available_stock INTO v_price, v_available_stock
    FROM Products
    WHERE product_id = p_product_id;

    -- Check stock availability
    IF v_available_stock < p_quantity THEN
        RAISE_APPLICATION_ERROR(-20002, 'Insufficient stock for product ID: ' || p_product_id);
    END IF;
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DELETEPRODUCTBYID" ( 
...
BEGIN
    ...
    IF SQL%ROWCOUNT > 0 THEN
        p_status := 'Product deleted successfully.';
        DBMS_OUTPUT.PUT_LINE('Product with ID ' || p_product_id || ' deleted successfully.');
    ELSE
        p_status := 'No product found with the provided ID.';
        DBMS_OUTPUT.PUT_LINE('No product found with ID: ' || p_product_id);
    END IF;

EXCEPTION
    WHEN OTHERS THEN
        p_status := 'Error occurred during deletion.';
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."GETALLPRODUCTS" (
...
/
--------------------------------------------------------
--  DDL for Procedure GETPRODUCTDETAILS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."GETPRODUCTDETAILS" ( 
    p_product_id IN NUMBER,
    p_name OUT VARCHAR2,
...
/
--------------------------------------------------------
--  DDL for Procedure GETPRODUCTDETAILSBYNAME
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."GETPRODUCTDETAILSBYNAME" ( 
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Received product name: ' || p_product_name);

    SELECT product_id, product_category, price, available_stock, product_image 
    INTO p_product_id, p_category, p_price, p_stock, p_image  
    FROM Products
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        ...
        p_stock := NULL;
        p_image := NULL; 
        DBMS_OUTPUT.PUT_LINE('No product found for name: ' || p_product_name);
...
/
--------------------------------------------------------
--  DDL for Procedure GET_CUSTOMER_CREDENTIALS_BY_EMAIL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."GET_CUSTOMER_CREDENTIALS_BY_EMAIL" (
    p_customer_email IN VARCHAR2,
    p_customer_id OUT NUMBER,
    p_stored_password OUT VARCHAR2
) AS
BEGIN
    --------------get customer_id and password
    SELECT customer_id, password
    INTO p_customer_id, p_stored_password
    FROM Customers
...
/
--------------------------------------------------------
--  DDL for Procedure INCREASE_ALLOWANCE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INCREASE_ALLOWANCE" (increase NUMBER) IS
     CURSOR emp_cursor IS
        SELECT EmpID, EmpName, EmpBasicSalary, EmpAllowance FROM EMPLOYEE WHERE EmpAllowance > 1000;
BEGIN
     FOR emp IN emp_cursor LOOP
         dbms_output.put_line('Employee ID: ' || emp.EmpID);
         dbms_output.put_line('Employee Name: ' || emp.EmpName);
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PLACE_ORDER" (
    p_customer_id IN NUMBER,
    p_product_ids IN SYS.ODCINUMBERLIST, --need this to iterate thro the products as its a loop
    p_quantities IN SYS.ODCINUMBERLIST, --need this to iterate thro the products as its a loop
...
BEGIN
    ...
    VALUES (p_customer_id, 0) --casue we cant add a tot at first, initialize it. got an error before.
    RETURNING order_id INTO v_order_id;



    -- check thro products  in it
    FOR i IN 1 .. p_product_ids.COUNT LOOP
        ...
        -- insert those values into order
        INSERT INTO Order_Items (order_id, product_id, quantity, subtotal)
        VALUES (v_order_id, p_product_ids(i), p_quantities(i), v_subtotal);
    ...
    -- update tot amount cause at first nothing is put there
    UPDATE Orders
...
/
--------------------------------------------------------
--  DDL for Procedure PLACE_ORDER_WITH_ITEMS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PLACE_ORDER_WITH_ITEMS" (
    p_customer_id NUMBER,
    p_order_items order_item_table,  -- Accepts multiple order items as a table type
    p_order_id OUT NUMBER
) AS
    v_subtotal NUMBER(10,2);
BEGIN
    -- Insert Order (initial total amount is 0)
    INSERT INTO Orders (customer_id, total_amount, status)
    VALUES (p_customer_id, 0, 'Pending')
    RETURNING order_id INTO p_order_id;

    -- Loop through order items and insert them
    FOR i IN 1 .. p_order_items.COUNT LOOP
        ...
        BEGIN
            ...
            -- Check stock availability
            IF v_available_stock < p_order_items(i).quantity THEN
                RAISE_APPLICATION_ERROR(-20002, 'Insufficient stock for product ID: ' || p_order_items(i).product_id);
            END IF;

            -- Calculate subtotal
            v_subtotal := v_price * p_order_items(i).quantity;

            -- Insert into Order_Items
            INSERT INTO Order_Items (order_id, product_id, quantity, subtotal)
            VALUES (p_order_id, p_order_items(i).product_id, p_order_items(i).quantity, v_subtotal);

            -- Update stock
            UPDATE Products
            SET available_stock = available_stock - p_order_items(i).quantity
            WHERE product_id = p_order_items(i).product_id;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATEITEMBYID
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATEITEMBYID" (
    p_product_id IN NUMBER,
    p_product_name IN VARCHAR2,
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATEPRODUCTBYID
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."UPDATEPRODUCTBYID" (
    p_product_id IN NUMBER,
    p_product_name IN VARCHAR2,
    p_product_category IN VARCHAR2,
    p_price IN NUMBER,
...
/
--------------------------------------------------------
--  DDL for Function AVERAGESALARY
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."AVERAGESALARY" RETURN NUMBER AS
  AvgSalary NUMBER;

BEGIN
   SELECT AVG (EmpBasicSalary + EmpAllowance) INTO AvgSalary FROM Employee;
   RETURN AvgSalary;
END;

/
--------------------------------------------------------
--  DDL for Function COUNTSALARY
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."COUNTSALARY" RETURN NUMBER AS
   EmpCount Number;

BEGIN
    SELECT COUNT (*) INTO EmpCount FROM Employee WHERE EmpBasicSalary > 75000;
    RETURN EmpCount;
END;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DELIVERY" ADD PRIMARY KEY ("DELIVERY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DEPARTMENT" ADD PRIMARY KEY ("DPTID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ORDER_ITEMS" MODIFY ("ORDER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORDER_ITEMS" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORDER_ITEMS" MODIFY ("QUANTITY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORDER_ITEMS" MODIFY ("SUBTOTAL" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PRODUCTS" MODIFY ("SUPPLIER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS" MODIFY ("PRODUCT_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS" MODIFY ("PRICE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTS" MODIFY ("AVAILABLE_STOCK" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SUPPLIER" MODIFY ("SUPPLIER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUPPLIER" ADD PRIMARY KEY ("SUPPLIER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DEPARTMENT1" ADD PRIMARY KEY ("DPTID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PAYMENTS" MODIFY ("PAYMENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAYMENTS" MODIFY ("ORDER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAYMENTS" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAYMENTS" MODIFY ("PAYMENT_METHOD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAYMENTS" MODIFY ("AMOUNT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAYMENTS" ADD PRIMARY KEY ("PAYMENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUSTOMERS" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMERS" MODIFY ("FULL_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMERS" MODIFY ("CUSTOMER_EMAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMERS" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CUSTOMERS" ADD UNIQUE ("CUSTOMER_EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DELIVERY" ADD FOREIGN KEY ("ORDER_ID")
	  REFERENCES "SYSTEM"."ORDERS" ("ORDER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMPLOYEE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."EMPLOYEE" ADD CONSTRAINT "FK_EMPLOYEE_DEPARTMENT" FOREIGN KEY ("EMPDPTID")
	  REFERENCES "SYSTEM"."DEPARTMENT" ("DPTID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ORDERS" ADD FOREIGN KEY ("CUSTOMER_ID")
	  REFERENCES "SYSTEM"."CUSTOMERS" ("CUSTOMER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ORDER_ITEMS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ORDER_ITEMS" ADD FOREIGN KEY ("ORDER_ID")
	  REFERENCES "SYSTEM"."ORDERS" ("ORDER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."ORDER_ITEMS" ADD FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "SYSTEM"."PRODUCTS" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PAYMENTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAYMENTS" ADD FOREIGN KEY ("ORDER_ID")
	  REFERENCES "SYSTEM"."ORDERS" ("ORDER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."PAYMENTS" ADD FOREIGN KEY ("CUSTOMER_ID")
	  REFERENCES "SYSTEM"."CUSTOMERS" ("CUSTOMER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PRODUCTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PRODUCTS" ADD FOREIGN KEY ("SUPPLIER_ID")
	  REFERENCES "SYSTEM"."SUPPLIERS" ("SUPPLIER_ID") ON DELETE CASCADE ENABLE;
